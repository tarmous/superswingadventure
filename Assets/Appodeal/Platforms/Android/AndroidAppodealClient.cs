...
#endif
			//Amazon ad network shold be disabled if user wants to use banner view or MREC.
			//We use android native popup window in these cases and this behaviour doesn't supported by Amazon.
