...
public class death_fog : MonoBehaviour {
	...
	void Start(){
		//Base Skin Array
			...
			color_base[0]= new Color(226, 188, 196, 255)/colorDenominator;
			color_base[1]= new Color(226, 188, 196, 255)/colorDenominator;
			color_base[2]= new Color(226, 188, 196, 255)/colorDenominator;
			color_base[3]= new Color(226, 188, 196, 255)/colorDenominator;
