...
public class front_hills : MonoBehaviour {
	...
	void Start(){
		...
		color_base = new Color[4];
			color_base[0]= new Color(169, 99, 89, 255)/colorDenominator;
			color_base[1]= new Color(104, 73, 92, 255)/colorDenominator;
			color_base[2]= new Color(53, 86, 162, 255)/colorDenominator;
			color_base[3]= new Color(22, 58, 117, 255)/colorDenominator;
